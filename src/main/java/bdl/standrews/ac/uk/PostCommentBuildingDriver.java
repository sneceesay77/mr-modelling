...
import bdl.standrews.ac.uk.ReduceSideJoinDriver.MAP_RED_CUSTOM;

public class PostCommentBuildingDriver {
	private static final Logger LOG = LoggerFactory.getLogger(ReduceSideJoinDriver.class.getName());
