...
import bdl.standrews.ac.uk.DistinctUserDriver.MAP_RED_CUSTOM;

public class QuestionAnswerBuildingDriver {
	private static final Logger LOG = LoggerFactory.getLogger(QuestionAnswerBuildingDriver.class.getName());
