...
import bdl.standrews.ac.uk.PlatformDefinedPhaseProfiler.MAP_RED_CUSTOM;

public class MinMaxCountDriver {
	private static final Logger LOG = LoggerFactory.getLogger(SOMinMaxCountMapper.class.getName());
